    ...
    return (
      <Background backgroundImage={waitingPageBackground}>
        <div className="bg-black bg-opacity-50 p-8 mb-12 rounded-lg shadow-lg w-full sm:w-96 mx-4">
          <h1 className="text-4xl font-bold text-white text-center mb-6">Waiting for Players</h1>
          <p className="text-white text-center mb-8">Players who joined the game will appear here.</p>
